    ...
    return new Promise((resolve, reject) => {
        ...
        pool.getConnection((err, connection) => {
            if (err) {
                ...
                /*fixed sql*/
                connection.execute (`UPDATE user SET role_id =? WHERE user_id=?`, [newRoleId, recordId], (err, rows) => {
                    if (err) {
                        reject(err);
                    } else {
                        resolve(rows);
    ...
    return new Promise((resolve, reject) => {
        ...
        pool.getConnection((err, connection) => {
            if (err) {
                ...
                connection.execute(userDataQuery, [recordId], (err, results) => {
                    if (err) {
                        reject(err);
                    } else {
                        resolve(results);
...
module.exports.getOneDesignData = function (recordId, userId) {
    ...
    /*fixed*/
    userDataQuery = `SELECT file_id,file_url,design_title,design_description 
    ...
    return new Promise((resolve, reject) => {
        ...
        pool.getConnection((err, connection) => {
            if (err) {
                ...
                connection.execute(userDataQuery, [recordId, userId], (err, results) => {
                    if (err) {
                        reject(err);
                    } else {
                        console.log(results)
    ...
    return new Promise((resolve, reject) => {
        ...
        pool.getConnection((err, connection) => {
            if (err) {
                ...
                connection.execute(`UPDATE file SET design_title =? , design_description=? WHERE file_id=? AND  created_by_id=?`, [title, description, recordId, userId], (err, rows) => {
                    if (err) {
                        reject(err);
                    } else {
                        resolve(rows);
